...
type StoreCapacity struct {
	...
	// out_of_disk_space records whether this store has exhausted its available
	// disk space.
	OutOfDiskSpace bool `protobuf:"varint,11,opt,name=out_of_disk_space,json=outOfDiskSpace" json:"out_of_disk_space"`
}
...
var fileDescriptor_ecd7f5cc803f82c8 = []byte{
	...
	,
}
...
func (m *StoreCapacity) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field OutOfDiskSpace", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
